...
def main():
    ...
    with open(f"{filename}.csv", "a") as file:
        file.write(str("Time, Timestamp, Heartrate, Breathing Rate, Skin Temperature, Posture, Activity, Peak Acceleration, Battery Voltage, Breathing Rate Amplitude, ECG Amplitude, ECG Noise, Vertical Acceleration Minimum, Vertical Acceleration Peak, Lateral Acceleration Minimum, Lateral Acceleration Peak, Sagittal Acceleration Minimum, Sagittal Acceleration Peak") + ',')
        file.write('\n')
    while True:
