    ...
    def tick(self, world, clock):
        ...
        def write_to_file(flag):
            with open("data_log.csv", "a") as file:
                #file.write("Timestamp,Speed,Throttle,Brake,Steer,AtTrafficLight,\n")
                file.write('\n')
                file.write(curr_time + ',' + str(vehicle_speed) + ',' + str(vehicle_throttle) + ',' + str(vehicle_brake) + ',' + str(vehicle_steer) + ',' + flag)
